...
@ContextConfiguration(locations = {"/chapter9/InjectingWithSpring/application-context.xml",
                                   "/chapter9/InjectingWithSpring/mock-application-context-with-spy.xml"})
public class TaxTransfererXmlConfigurationWithSpyTestNgTest extends AbstractTestNGSpringContextTests {
